...
## Showcase MVP Mode (48h)

For the customer presentation, prioritize a “perfect looking & feeling” Premium Fashion-Tech prototype (Homepage → PDP → Slide-over Cart) with real seeded products. Heavy enterprise back-office topics are postponed to Phase 2:
- ERP Sync Pipeline (DTO + Queue/Event)
- Meilisearch / Vector Search
- Filament Multi-Panel isolation & deep RBAC
