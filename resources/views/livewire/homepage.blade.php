<div>
    <section
        ...
        @mouseenter="stop()"
        @mouseleave="start()"
        class="-mx-4 w-full overflow-hidden bg-white shadow-sm sm:mx-0 sm:rounded-2xl sm:border sm:border-gray-200"
    >
        <div class="relative">
            <template x-for="(slide, idx) in slides" :key="idx">
                ...
                >
                    <div class="relative aspect-[16/6] w-full bg-gray-100">
                        <img :src="slide.image" alt="" class="absolute inset-0 h-full w-full object-cover" loading="eager" />
    ...
    <section id="categories" class="mt-6">
        <div class="grid grid-cols-4 gap-2 md:grid-cols-2 md:gap-4">
            @php
                $categoryCards = [
                    ['label' => 'QADIN', 'image' => 'https://images.unsplash.com/photo-1525966222134-fcfa99b8ae77?auto=format&fit=crop&w=1200&q=80'],
                    ['label' => 'KİŞİ', 'image' => 'https://images.unsplash.com/photo-1491553895911-0055eca6402d?auto=format&fit=crop&w=1200&q=80'],
                    ['label' => 'UŞAQ', 'image' => 'https://images.unsplash.com/photo-1514090458221-65bb69cf63e6?auto=format&fit=crop&w=1200&q=80'],
                    ['label' => 'İDMAN', 'image' => 'https://images.unsplash.com/photo-1556906781-9a412961c28c?auto=format&fit=crop&w=1200&q=80'],
                ];
            @endphp
